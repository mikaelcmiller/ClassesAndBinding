...
#### Created from Google Sheet 
		...
		self.CommitBtn = Button(self, text="Commit", command=self.write_output)
		...
		self.CanPred = Label(self,text="Pred Can Values")
		self.CanPred.grid(row=21, column=6)
		self.QCCheckCan = Label(self,text="QC Check Can")
		self.QCCheckCan.grid(row=22, column=7, sticky=W)
		...
		self.CanPoly1.grid(row=23, column=7, sticky=W)
		...
		self.CanPolyMean.grid(row=26, column=7, sticky=W)
		...
		self.CanQCPoly.grid(row=27, column=7, sticky=W)
		...
		self.ReptoYr3.grid(row=29, column=7, sticky=W)
		...
		self.XRefCanSal.grid(row=30, column=7, sticky=W)
		...
		self.Adder.grid(row=31, column=7, sticky=W)
		...
		self.SocOutputLabel.grid(row=2, column=7, rowspan=2, sticky=NW)
